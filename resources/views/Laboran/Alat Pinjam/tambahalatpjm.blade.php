...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
            <div class="card-body">
              <a href="{{route('alatpjm')}}" class="btn btn-primary mb-3 mt-3"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
              <form class="row g-3" method="POST" action="/alatpjm-insert"  enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Your Name">
                    <label for="floatingName">Tempat Peminjaman</label>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    ...
                    <label for="floatingName">Tanggal Pinjam</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-floating">
                    <input type="time" class="form-control" id="floatingName" placeholder="Your Name">
                    <label for="floatingName">Waktu Mulai</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-floating">
                    <input type="time" class="form-control" id="floatingName" placeholder="Your Name">
                    <label for="floatingName">Waktu Berakhir</label>
                  </div>
                </div>
