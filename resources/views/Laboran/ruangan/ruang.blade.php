    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <a href="{{ route('truang')}}" class="btn btn-primary mt-3">Tambah Ruangan</a>
            ...
            <img src="{{ asset('Foto Ruang/'. $data->foto_ruangan) }}" width="200" height="150" alt="Foto Ruang" style="display: block;">
            </td>
            <td>{{$data->status}}</td>
                  <td>{{$data->lantai}}</td>
                    <td>
