...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
            <div class="card-body">
            <a href="{{route('ruang')}}" class="btn btn-primary mb-3 mt-3"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
              ...
              <form class="row g-3" method="POST" action="/ruang-insert"  enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="nama_ruangan" name="nama_ruangan" placeholder="Your Name">
                ...
                <div class="form-floating">
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="foto_ruangan" name="foto_ruangan" accept="image/*">
                  </div>
                </div>
            </div>
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="gedung" name="gedung" placeholder="Gedung">
                    <label for="floatingSelect">Gedung</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select class="form-select" id="lantai" name="lantai" aria-label="State">
                ...
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="laboran" name="laboran" placeholder="laboran">
