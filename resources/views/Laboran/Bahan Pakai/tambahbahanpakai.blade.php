                    ...
                    <div id="dynamic-input-container">
                        <div class="dynamic-input-row row mt-3 align-items-center">
                            <div class="col-12 d-flex align-items-center">
                                ...
                                <div class="col-4">
                                    <button type="button" class="btn btn-success btn-sm ms-2" onclick="addInputRow()">Tambah</button>
                                </div>
                            </div>
...
<script>
    ...
    function fillSatuan(selectElement) {
        ...
        jumlahInput.max = maxJumlah; // Mengatur batas maksimum jumlah
        jumlahInput.placeholder = "Max = " + maxJumlah; // Menampilkan placeholder dinamis
    }
