...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
            <div class="card-body">
              <a href="{{route('bahan')}}" class="btn btn-primary mb-3 mt-3"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
              <form class="row g-3" method="POST" action="/bahan-insert"  enctype="multipart/form-data">
                @csrf
                <div class="col-md-8">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="nama_bahan" name="nama_bahan" placeholder="Your Name">
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="foto_bahan" name="foto_bahan" accept="image/*">
                </div>
                </div>
                
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="stok" name="stok" placeholder="Your Name">
                ...
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select class="form-select" name="satuan" id="floatingSelect" aria-label="State">
