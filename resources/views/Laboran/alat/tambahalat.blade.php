...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
            <div class="card-body">
              <a href="{{route('alat')}}" class="btn btn-primary mb-3 mt-3"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
              <form class="row g-3" method="POST" action="/alat-insert"  enctype="multipart/form-data">
                @csrf
                <div class="col-md-8">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="nama_alat" name="nama_alat" placeholder="Your Name">
